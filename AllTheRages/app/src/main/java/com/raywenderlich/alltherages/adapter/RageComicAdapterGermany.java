...
public class RageComicAdapterGermany extends RecyclerView.Adapter<RageComicViewHolder> implements Filterable {
    private static String TAG = RageComicAdapterGermany.class.toString();
    @Override
